...
class Queue:
	...
	def push(self, item):
		...
		return Queue(self.incoming, self.outgoing.push(item)) if self.incoming.isEmpty() and self.outgoing.isEmpty() else Queue(self.incoming.push(item), self.outgoing)
